...
var validSort = {
    ...
    Beauty: 'title',
    Books: 'title',
    WirelessAccessories: 'title',
    Apparel: 'title',
    Collectibles: 'title',
    PCHardware: 'title',
    Electronics: 'title',
    Grocery: 'title',
    HealthPersonalCare: 'title',
    HomeGarden: 'title',
    Industrial: 'title',
    Jewelry: 'title',
    KindleStore: 'title',
    ...
    DigitalMusic: 'title',
    Music: 'title',
    MusicalInstruments: 'title',
    OfficeProducts: 'title',
    OutdoorLiving: 'title',
    LawnGarden: 'title',
    PetSupplies: 'title',
    Shoes: 'title',
    ...
    function callWithOptions(options) {
        ...
        prodAdv.call("ItemSearch", options, function(err, result) {
            ...
            items.push({
                minPrice: minPrice,
                maxPrice: maxPrice,
                items: result.Items !== undefined ? result.Items.Item.splice(0, 8).sort(function(a,b){
